  ...
  _bindModal: function () {
    Modal({
      ...
      html:
        ...
        '<div class="field"><label>Email</label><input class="input" id="b-email" type="email" placeholder="you@realm.jp" /></div>' +
  ...
  _settingsModal: function () {
    Modal({
      ...
      html:
        ...
        '<div class="panel" style="margin-bottom:14px"><div class="muted" style="font-size:12px">Realm</div><div style="font-weight:700;color:var(--gold)">' + esc(localStorage.getItem('shogun_stateName') || 'State 391') + '</div></div>' +
