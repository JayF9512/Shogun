...
(function () {
  ...
  // Canonical, single-source terminology. The game world is divided into
  // numbered "States" (never "realms" or "servers"). Use these strings for all
  // player-facing copy so terminology stays consistent across every screen.
  var TERMS = {
    STATE: 'State',                 // a single numbered world (e.g. "State 1")
    STATE_PLURAL: 'States',
    STATE_DEFAULT_NAME: 'State 1',  // the launch state
    SELECT_STATE: 'Select Your State',
    ENTER: 'Enter the State',
    LOADING_WORLD: 'Entering the State'
  };
